	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
		<div class="container-fluid">
			...
			if($loggedin){
				echo 
				'<li class="nav-item">
					<span class="navbar-text text-white bg-dark mr-5">Hello, '.  $nama .' !</span>
				</li>';
			}
		?>
			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button type="button" id="submit-buy-button" name="submit" class="btn btn-success"><span
								class="lnr lnr-cart"></span> Buy</button>
					</div>
				</div>
			</div>
		</div>
...
input:disabled{
	...
	<script>
		function load_data() {
			$.ajax({
				url: "/ProyekTekweb/services/get_all_item.php",
				method: "GET",
								...
								$(
									`<div class="col-12 col-md-6 mt-5">
										<a class="selectitem" href="#">
											...
											<div class="hargabaju" style="display:none">` + baju['harga'] + `</div>
										</a>
									</div>`
								);
